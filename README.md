...
** Recipes Application** is a Ruby on Rails aplication to keep track of a Recipes data.
...
```sh
  git clone https://github.com/MarcoDDM/recipe
  cd my-folder
```
...
Feel free to check the [issues page](https://github.com/MarcoDDM/recipe/issues).
